            ...
            <form onSubmit={handleSubmit} className="space-y-5 text-left">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    className="bg-white/8 border-white/15 text-white placeholder:text-white/30 focus-visible:border-white/40 focus-visible:ring-white/20 rounded-xl h-11"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 gap-2 w-full">
                ...
                >
                  <SelectTrigger
                    id="role-select"
                    className="bg-white/8 border-white/15 text-white focus:ring-white/20 rounded-xl h-11 w-full data-[placeholder]:text-white/30"
                  >
                  ...
                  <SelectContent className="bg-[#1a1f2e] border-white/10">
                    {ROLES.map((r) => (
                      <SelectItem
                        key={r.value}
                        value={r.value}
                        className="text-white/80 hover:bg-white/10 focus:bg-white/10 focus:text-white data-[highlighted]:bg-white/10 data-[highlighted]:text-white"
                      >
                        {r.label}
                      </SelectItem>
                    ))}
...
// import { usestatus, useRef } from "react";
// import { motion, useInView } from "motion/react";
// import { ArrowRight, CheckCircle2, Loader2 } from "lucide-react";
// import { Input } from "@/components/ui/input";
// import { Label } from "@/components/ui/label";
...
//   const [fullName, setFullName] = usestatus("");
//   const [email, setEmail] = usestatus("");
//   const [role, setRole] = usestatus("");
//   const [status, setFormstatus] = usestatus<Formstatus>("idle");
//   const [errorMsg, setErrorMsg] = usestatus("");
